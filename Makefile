# This Makefile is for the Yahoo::Weather extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Yahoo/Weather.pm]
#     AUTHOR => q[Krishna Chaitanya Averineni <kchaitan@apple.com>]
#     BUILD_REQUIRES => {  }
#     DEFINE => q[]
#     INC => q[-I.]
#     LIBS => [q[]]
#     NAME => q[Yahoo::Weather]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Yahoo/Weather.pm]
...
MAKE = make
FULLEXT = Yahoo/Weather
BASEEXT = Weather
PARENT_NAME = Yahoo
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Yahoo/Weather.pm
INC = -I.
DEFINE = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Yahoo/Weather.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Yahoo
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Yahoo
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Yahoo/Weather.pm $(INST_MAN3DIR)/Yahoo::Weather.$(MAN3EXT) 
